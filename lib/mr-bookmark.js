...
=======
var MrBookmarkView = require('./mr-bookmark-view');
var {CompositeDisposable} = require('atom');

var MrBookmarkView =  null;
var modalPanel =  null;
var subscriptions =  null;

var MrBookmark = {};

MrBookmark.activate = function(state) {
...
>>>>>>> Stashed changes
  ...
  this.MrBookmarkView.getAddButton().addEventListener("click", function() {
    ...
    self.MrBookmarkView.addItem(file);
    self.addEventListeners();
  });
};

MrBookmark.addEventListeners = function() {
  var self = this;
