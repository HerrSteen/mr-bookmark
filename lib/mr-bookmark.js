...
const MrBookmark = {
  ...
  activate(state) {
    ...
    this.MrGit.addChangeListener(this.FileListView.addChangedGitColor);
    this.MrGit.addAllChangeListener(this.FileListView.addChangedGitColor);
  ...
  addFileButtonClick(evt) {
    ...
    if (this.FileListView.fileDoesExist(filePath))
      return;
